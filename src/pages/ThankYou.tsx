 ...
 import gauravEventImage from '@/assets/event-1.jpg';
     ...
     <div className="min-h-screen bg-secondary flex items-center justify-center px-4 py-12">
       <div className="max-w-lg w-full">
         ...
         <div className="bg-card rounded-2xl shadow-lg p-8 md:p-10 text-center">
           {/* Success icon */}
           <div className="w-20 h-20 mx-auto mb-6 bg-accent/10 rounded-full flex items-center justify-center animate-fade-in-up">
             <CheckCircle className="w-10 h-10 text-accent" />
           </div>
 
           {/* Heading */}
           <h1 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-3 animate-fade-in-up">
             You're In! 🎉
           </h1>
           ...
           {/* What's Next */}
           <div className="space-y-3 mb-8 text-left animate-fade-in-up animation-delay-200">
             <h3 className="font-semibold text-foreground text-center mb-4">What's Next?</h3>
             <div className="flex items-center gap-3 p-3 bg-secondary rounded-lg">
               <Calendar className="w-5 h-5 text-accent flex-shrink-0" />
               <span className="text-sm text-muted-foreground">Webinar date & time will be shared in the group</span>
             </div>
             <div className="flex items-center gap-3 p-3 bg-secondary rounded-lg">
               <Clock className="w-5 h-5 text-accent flex-shrink-0" />
               <span className="text-sm text-muted-foreground">You'll get reminders before the session</span>
             </div>
             <div className="flex items-center gap-3 p-3 bg-secondary rounded-lg">
               <Users className="w-5 h-5 text-accent flex-shrink-0" />
               <span className="text-sm text-muted-foreground">Connect with like-minded professionals</span>
             </div>
           </div>
